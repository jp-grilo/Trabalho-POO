...
public class Medico extends Pessoas implements Procedimentos{
    ...
    public void atendimento(ArrayList filaAtendimento, Pacientes paciente) throws EmptyProntuarioExcpetion, ServiceFailureException{
        Scanner sc = new Scanner(System.in);
        System.out.println(paciente.resumo());
        System.out.println("Qual o diagnostico do paciente?");
        String prontuario = sc.nextLine();
        if(prontuario == "" || prontuario == null){ /*implementar exceção de prontuario vazio*/
            throw new EmptyProntuarioException();
        }
        ...
        else{ /*implementar exceção caso falha ocorra*/
