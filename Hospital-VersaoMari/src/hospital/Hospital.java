...
public class Hospital {
    public static void main(String[] args) {
        ...
        System.out.println("Encerrando o expediente e gerando o relatório do dia. Até a próxima!");
