...
public class Enfermaria implements Procedimentos{
    ...
    @Override
    public void lerListaCadastro(ArrayList<Pacientes> listaCadastro) {
    ...
    @Override
    public void lerPacienteCadastro(ArrayList<Pacientes> listaCadastro, Pacientes paciente){
    ...
    public ArrayList<Pacientes> getCadastro() {
        return cadastro;
    }

    public void setCadastro(ArrayList<Pacientes> cadastro) {
        this.cadastro = cadastro;
    }

    public ArrayList<Pacientes> getAtendimento() {
        return atendimento;
    }

    public void setAtendimento(ArrayList<Pacientes> atendimento) {
        this.atendimento = atendimento;
    }
